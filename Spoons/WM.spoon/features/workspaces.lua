...
local function ensureModes(commands, actions, count)
  ...
  local workspaceBindings = {
    { key = "h", fn = function() commands:execute("workspace.send.prev") end, exit = true },
    { key = "l", fn = function() commands:execute("workspace.send.next") end, exit = true },
    { key = "[", fn = function() commands:execute("workspace.focus.prev") end },
    { key = "]", fn = function() commands:execute("workspace.focus.next") end },
  }
